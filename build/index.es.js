import { createElement, createContext, useState, useEffect, Fragment, useContext } from 'react';
...
var StyledTextField = withStyles(styles$6)(TextField);
...
var InputField = function (props) {
    ...
    switch (type) {
        ...
        case 'email':
        case 'password':
            return (createElement(StyledTextField, __assign({}, rest, { isFocused: isFocused, onFocus: onFocusWrapper, onBlur: onBlurWrapper, onChange: onChangeWrapper, disabled: disabled, placeholder: placeholder, type: type, name: name, errorMsg: errorMsg, value: internalValue, appendContent: appendContent, prependContent: prependContent })));
    }
    return createElement("input", __assign({}, props));
};

export { StyledBody as Body, StyledButton as Button, StyledCol as Col, StyledContainer as Container, StyledForm as Form, FormContext, WrappedGlobalStyles as GlobalStyles, InputField, StyledRow as Row, ThemeProvider, StyledTitle as Title, StyledCard as Wrapper };
