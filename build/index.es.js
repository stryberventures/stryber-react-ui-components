import { createElement, Fragment, createContext, useState, useEffect, useContext } from 'react';
...
var Form = function (props) {
    ...
    return (createElement("form", __assign({}, rest, { onSubmit: onSubmitFormWrapper, onReset: onResetFormWrapper, className: classnames([
            classes.root,
        ]), key: formSessionId }),
...
var StyledTextInput = withStyles(styles$6)(TextInput);
...
var InputField = function (props) {
    ...
    switch (type) {
        case 'submit':
        case 'reset':
            return (createElement(StyledButton, { type: type }, value || type));
        case 'text':
        case 'number':
        case 'email':
        case 'password':
...
var RadioField = function (props) {
    ...
    return (createElement("label", { className: classes.root },
        createElement("input", __assign({}, rest, { className: classes.input, name: name, value: value, type: "radio", checked: checkedValue, onChange: onChangeWrapper })),
        createElement("span", { className: classes.checkmark }),
        createElement("div", { className: classes.placeholder }, placeholder)));
};
var StyledRadioField = withStyles(styles$8)(RadioField);

export { StyledBody as Body, StyledButton as Button, StyledCol as Col, StyledContainer as Container, Eye, EyeDisabled, StyledForm as Form, FormContext, InputField, StyledPasswordField as PasswordField, PrependBackground, index as Profile, StyledRadioField as RadioField, StyledRow as Row, ThemeProvider, StyledTitle as Title, StyledCard as Wrapper };
