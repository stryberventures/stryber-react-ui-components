...
var InputField = function (props) {
    ...
    /** Getting values from Form context (if the field is wrapped inside a form */
    var _g = React.useContext(FormContext), updateFormValue = _g.updateFormValue, updateFormTouched = _g.updateFormTouched, unsetFormValue = _g.unsetFormValue, formValues = _g.formValues, formErrors = _g.formErrors, formTouched = _g.formTouched;
    /** Getting error message from form errors */
    var errorMsg = (name && formTouched && formTouched[name] && formErrors[name]) || errorMessage;
    /** Setting the internal value of the field from form initial values or from value provided to the field */
    var _h = __read(React.useState((name && formValues && formValues[name]) || value), 2), internalValue = _h[0], setInternalValue = _h[1];
    /** Wrappers to merge form and props methods */
    var onChangeWrapper = function (e) {
        var _a = e.target, name = _a.name, targetValue = _a.value;
