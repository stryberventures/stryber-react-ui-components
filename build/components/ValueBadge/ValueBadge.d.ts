...
declare const StyledValueBadge: React.ComponentType<Pick<IValueProps & React.HTMLProps<HTMLDivElement> & WithStyles<(theme: any) => {
    wrapper: {
        borderRadius: number;
        backgroundColor: any;
        display: string;
