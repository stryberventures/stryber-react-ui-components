...
declare const StyledRadioField: React.ComponentType<Pick<IRadioFieldProps & React.HTMLProps<HTMLInputElement> & WithStyles<(theme: any) => {
    root: {
        transition: string;
        position: string;
        cursor: string;
